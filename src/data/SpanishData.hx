...
class SpanishData
{
	...
	public static var femaleGiven = [
		'María', 'Catalina', 'Isabel', 'Ana', 'Juana', 'Francisca', 'Beatriz', 'Inés', 'Leonor', 'Mencía', 'Elvira', 'Luisa', 'Teresa', 'Antonia',
		'Margarita', 'Mariana', 'Marina', 'Quiteria', 'Constanza', 'Juliana', 'Lucia', 'Magdalena', 'Mayor', 'Sancha', 'Agueda', 'Andrea', 'Angela', 'Antona',
		'Barbola', 'Clara', 'Costanza', 'Cristina', 'Damiana', 'Floriana', 'Jerónima', 'Melchora', 'Olall', 'Susana', 'Ursula', 'Violante',
	];

	public static var locative = [
		'de Aguilar', 'de Avila', 'de Torres', 'de Medina', 'de Herrera', 'de León', 'del Castillo', 'de Ribera', 'de Espinosa', 'de Baeza', 'de Mendoza',
		'de Alvarado', 'de Castro', 'de la Fuente', 'de Salazar', 'de Burgos', 'de Zárate', 'de Rojas', 'de Segovia', 'de Cáceres', 'de Fuentes',
		'de Montoya', 'de Trujillo', 'de Céspedes', 'de Valencia', 'del Valle', 'de Molina', 'de Navarrete', 'de Palencia', 'de Santa Cruz', 'de la Corona',
		'de la Cueva', 'de Jerez', 'de Olivares', 'de Ovando', 'de Paz', 'de Porras', 'de Rivera', 'de la Torre', 'de Vadillo', 'de Ahumada', 'de Anero',
		'de la Palma', 'de San Martín', 'de San Millán', 'de Saucedo', 'de Soto', 'de Anania', 'de Andrada', 'de Aracena', 'de Aranda', 'de Araújo',
		'de Barrionuevo', 'de Calatrava', 'de Carrión', 'de Castilla', 'de Eslava', 'de Foronda', 'de Luján', 'de Marchena', 'de Monsalve', 'de Moraza',
		'de Onís', 'de Ozayta', 'de Palategui', 'de Porres', 'de Robledo', 'de Samaniega', 'de Tapia', 'de Tejeda', 'de Valderrama', 'de Villanueva',
		'de Villarreal', 'de la Corredera', 'del Hoyo', 'de Lepe', 'de Trillo', 'Montañés',
	];
