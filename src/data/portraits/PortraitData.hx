...
class PortraitData
{
	...
	public static function Init()
	{
		...
		EYES_M_1 = new PortraitEyes(dat.eyes_m_1.toTile());
		EYES_M_2 = new PortraitEyes(dat.eyes_m_2.toTile());

		EYES_F = [EYES_F_1, EYES_F_2, EYES_F_3];
		EYES_M = [EYES_M_1, EYES_M_2];

		CLOTHES_1 = new PortraitClothes(dat.clothing1.toTile());
		CLOTHES_2 = new PortraitClothes(dat.clothing2.toTile());
		CLOTHES_3 = new PortraitClothes(dat.clothing3.toTile());

		CLOTHES_F = [CLOTHES_1, CLOTHES_2, CLOTHES_3];
		CLOTHES_M = [CLOTHES_1, CLOTHES_2, CLOTHES_3];
		...
		HAIR_M_1 = new PortraitHair(dat.hair_m_1_front.toTile());
		HAIR_M_2 = new PortraitHair(dat.hair_m_2_front.toTile());
		HAIR_M_3 = new PortraitHair(dat.hair_m_3_front.toTile());

		HAIR_F = [HAIR_F_1, HAIR_F_2, HAIR_F_3, HAIR_F_4];
		HAIR_M = [HAIR_M_1, HAIR_M_2, HAIR_M_3];
		...
		NOSE_M_1 = new PortraitNose(dat.nose_m_1.toTile());
		NOSE_M_2 = new PortraitNose(dat.nose_m_2.toTile());
